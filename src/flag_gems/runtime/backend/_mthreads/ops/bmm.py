...
EXPAND_CONFIG_FILENAME = os.path.normpath(os.path.join(os.path.dirname(__file__), "..", "bmm_mthreads_expand.yaml"))
...
@libtuner(
    ...
    key=["M", "N", "K"],
    strategy=runtime.get_expand_config("bmm_sqmma", yaml_path=EXPAND_CONFIG_FILENAME)["strategy"][:3]
    if os.environ.get("USE_FLAGTUNE") == "1"
